...
class UsersQueries {
   ...
   * @returns {string}
   */
  static getUsersListFieldsQuery(isMyself = true) {
    return `
      data {
        ${UsersQueries.getAuthorPreviewFieldsWithMyselfData(isMyself)}
      }
   ...
   * @private
   */
  static getAuthorPreviewFieldsWithMyselfData(isMyself = true) {
    return `
      I_follow 
      followed_by
