...
class GraphQLSchemaService {
  ...
  static getUserWallFeedQueryPart(params, isMyself = true) {
    return `
      user_wall_feed(user_id: ${params.filters.user_id}, page: ${params.page}, per_page: ${params.per_page}, comments_query: {page: ${params.comments.page}, per_page: ${params.comments.per_page}}) {
